const previews = ["./Images/Ferrari Symbol.png", "./Images/Groveeee Icon.png", "./Images/Rumble.png", "./Images/Mlungisi Logo.png" , "./Images/Trigger Tempo.png", "./Images/Bullets Hurt.png", "./Images/Prop Hunt.png"];
const pages = ["./Ferrari Website/Ferrari-Website.html", "./Groveeee/Groveeee.html", "./Rumble/Rumble.html", "./Mlungisi Foundation/Mlungisi-Foundation.html" , "./Tempo Trigger/Tempo-Trigger.html", "./Bullets Hurt/Bullets-Hurt.html", "./Hide And See-bu/Hide-And-See-bu.html"];
let carouselDots = [];
